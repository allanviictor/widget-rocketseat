...
export function WidgetForm(){
    ...
    return(
        <div className="bg-zinc-900 p-4 relative rounded-2xl  mb-4 flex flex-col items-center md:w-auto w-[calc(100vw-2rem)] min-w-[400px]">
            ...
            {!feedbackType ? <FeedbackTypeStep onFeedbackTypeChanged={setFeedbackType} />:<FeedbackTypeContent returnFeedbackTypeStep={setFeedbackType} FeedbackType={feedbackType}/>}
