...
interface FeedbackSuccessProps {
    onFeedbackTypeChanged: ((value:null) => void)
    onFeedbackSend: ((value:boolean) => void)
}

export function FeedbackSuccess({onFeedbackTypeChanged,onFeedbackSend}:FeedbackSuccessProps) {
    return (
        <>
            <header>
                <CloseButton />
            ...
            <div className="flex flex-col items-center py-10 w-[384px]">
                ...
                <button type="button" onClick={()=> {onFeedbackTypeChanged(null),onFeedbackSend(false)}} className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6">
